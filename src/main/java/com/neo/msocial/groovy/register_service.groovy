...
String initDuyTriTransaction(String transactionId) {
...
//update transaction
String updateTransaction (String transactionId, String transactionStatus, String transactionResponse,
...
//update transaction
String getHoahong ( String transactionId, double price, int mobType, String startActiveDate, int cs ){
    String result = "";
    try {
        request = """
		<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:vms="http://vms.neo">
...
try {
    ...
    if (!is_doi_goi.equals("1") && (context.get("SERVICE_KEY").equals("MOBILEINTERNET") || context.get("SERVICE_KEY").equals("FAST_CONNECT")) && (info != null && info[0].equals("3")) && (context.get("CHANGE_PACKAGE").equals("1"))) {
        ...
        if (msgId < 0) {
            ...
            context.put("ErrorDescAPI", "Loi he thong khong khoi tao duoc giao dich.");
            return false;
        }
        ...
        context.put("ErrorCodeAPI", "0");
        context.put("ErrorDescAPI", String.valueOf(transactionId) + "|Giao dịch đã được giới thiệu cho thuê bao");
        return false;
    } else {
                    ...
                    try {
                        ...
                        if (cmdResultId >= 0) {
                            ...
                            if (!cmdStatus.equals("INUSE")) {
                                context.put("ErrorCodeAPI", "50");
                                context.put("ErrorDescAPI", "Thue bao chua cai dat dich vu Funring nen khong the cai dat dich vu Funring Me. Lien he 9090 de biet them thong tin.");
                                if (context.get("SEND_SMS").equals("1") && context.get("channel").equals("SMS")) {
                                            ...
                                            try {
                                                ...
                                                if (cmdResultId >= 0) {
                                                    ...
                                                    if (!cmdStatus.toUpperCase().equals("SUCCESS")) {
                                                        ...
                                                        charging = "0";
                                                        transactionStatus = "0";
                                                        context.put("ErrorCodeAPI", transactionStatus);
        ...
        try {
            ...
            try {
                ...
                if (transactionStatus.equals("1") && result.equals("1")) {
                    if (result.equals("1")) {
                        int tmp = 0; if (mobType.equals("MG")) {
                            tmp = 2;
                        } else if (mobType.equals("MC")) {
                            tmp = 1
                        };
                        int type_cs = 1; double price_new = price;
                        if (price_old > 0) {
                            price_new = price - price_old; type_cs = 3
                        };
                        ...
                        try {
                            ...
                            context.put("ErrorCodeAPI", "61");
                            context.put("ErrorDescAPI", "Giao dich khong duoc chot hoa hong " + result);
                        }
                    }
                }
            } catch (Exception ex) {
